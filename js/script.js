...
$(document).ready(function () {
  ...
  user_menu.classList.remove('active'); 
		...
		if (!e.target.closest('.header-menu__icon') && !e.target.closest('.adaptive-header-menu') && !e.target.closest('.popup')) {
			var menuAd = document.querySelector('.adaptive-header-menu');
			var menuAdMask = document.querySelector('.adaptive-header-menu__mask');
			var menuIco = document.querySelector('.header-menu__icon');
			var body = document.querySelector('body');
			menuAd.classList.remove('active');
			menuAdMask.classList.remove('active');
	...
	$('.price-item').click(function () {
		$('.price-item').removeClass('price-item_active');
	...
	$('.popup-close,.popup__close,.cancel-btn').click(function (event) {
		popupClose();
		return false;
	});
